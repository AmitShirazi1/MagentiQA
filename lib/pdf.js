...
/* ── Cover page ── */
.cover { padding: 56px 50px 28px; text-align: center; border-bottom: 3px solid #C026D3; }
...
.cover-sub { font-size: 11px; color: #64748b; margin-top: 6px; letter-spacing: 0.5px; }
...
.cover-meta .label { color: #94a3b8; font-weight: 700; text-transform: uppercase; font-size: 8.5px; letter-spacing: 1.2px; }
.cover-meta .value { color: #1a1a2e; margin-top: 3px; font-size: 12px; font-weight: 600; }
