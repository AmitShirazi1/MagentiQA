...
const { SETUP_PREAMBLE, DEFAULT_SETUP_TEXT } = require('./setups');
      ...
      <div class="detail-page page-break">
        <div class="detail-header">
          <div>
            ...
            ${test?.description ? `<p class="detail-desc">${esc(test.description)}</p>` : ''}
...
.detail-desc { font-size: 12px; color: #334155; line-height: 1.5; margin-top: 6px; max-width: 70ch; white-space: pre-wrap; }
...
<section class="page-break">
  ...
  <p>${esc(SETUP_PREAMBLE)}</p>
  <div style="white-space:pre-wrap">${esc(version.defaultSetup || DEFAULT_SETUP_TEXT)}</div>
</section>
