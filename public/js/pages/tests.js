    ...
    el.innerHTML = `
      <div class="page-header">
        ...
        <div class="btn-row">
          ...
          <button class="btn-secondary" onclick="exportVersionReport('${versionId}')">${ICONS.download} Export PDF</button>
          <button class="btn-secondary" onclick="exportVersionToDrive('${versionId}', this)">${ICONS.upload} Export to Drive</button>
